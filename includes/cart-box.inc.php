<div class="ui segment">
    ...
    <a class="ui right labeled icon button" href="addToFavorites.php?id=<?php echo $row['PaintingID']; ?>&file=<?php echo $row['ImageFileName']; ?>&title=<?php echo urlencode($row['Title']); ?>">
