          ...
          <li class="item">
            ...
            <div class="content">
              ...
              <div class="extra">
                ...
                <a class="ui icon button" href="addToFavorites.php?id=<?php echo $work['PaintingID']; ?>&file=<?php echo $work['ImageFileName']; ?>&title=<?php echo urlencode($work['Title']); ?>"><i class="heart icon"></i></a>
              </div>        
            </div>      
          </li>
